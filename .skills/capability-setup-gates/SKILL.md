...
| Skill              | Type       | Required                                                |
| ------------------ | ---------- | ------------------------------------------------------- |
| `/capability-record-decision` | Capability | Yes — records gate configuration decision               |
...
- **Input**: `/process-bootstrap` invokes `/capability-setup-gates` during project setup to establish initial quality gates.
- **Output**: Returns gate configuration summary. `/process-bootstrap` includes changes in the bootstrap commit.
