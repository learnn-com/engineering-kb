---
name: capability-assess-observability
description: "Assess observability strategy using resolution cascade (Argument > Adoption > Assessment). Reads observability guidelines, proposes monitoring/logging/tracing choices, writes infrastructure.md observability section, composes /capability-record-decision. Idempotent."
version: 0.4.1
author: Foomakers
---

# /capability-assess-observability — Observability Assessment
...
| Skill              | Type       | Required                                              |
| ------------------ | ---------- | ----------------------------------------------------- |
| `/capability-record-decision` | Capability | Yes — records observability decision as ADR or ADL    |
...
- **Input**: `/process-bootstrap` invokes during Phase 2, after /capability-assess-infrastructure.
