...
# /process-refine-story — Story Refinement
...
- If `/capability-write-issue` is not installed, warn and provide the formatted story body for manual PM tool update.
...
- Template ordering: functional sections first, technical sections last. This positions Technical Analysis as the bridge to Task Breakdown (added by `/process-plan-tasks`).
