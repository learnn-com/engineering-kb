---
name: capability-assess-testing
description: "Assess testing strategy using resolution cascade (Argument > Adoption > Assessment). Reads testing guidelines, proposes framework and strategy, writes testing section of tech-stack.md, composes /capability-record-decision. Idempotent."
version: 0.4.1
author: Foomakers
---

# /capability-assess-testing — Testing Strategy Assessment
...
| Skill              | Type       | Required                                      |
| ------------------ | ---------- | --------------------------------------------- |
| `/capability-record-decision` | Capability | Yes — records testing decision as ADL or ADR  |
...
- **Input**: `/process-bootstrap` invokes `/capability-assess-testing` during Phase 2. May pass `$choice` if developer pre-selected.
...
- If tech-stack.md doesn't exist, create it with testing section as initial content. Warn: "Created tech-stack.md — other sections should be populated by /capability-assess-stack."
...
- **Section ownership**: this skill writes ONLY the Testing section of tech-stack.md. /capability-assess-stack owns core sections, /capability-assess-ai owns AI section.
